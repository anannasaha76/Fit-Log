...
import FitImg from "@/assets/foot.png";
...
export const Footer: React.FC = () => {
  return (
    ...
    <Image src={FitImg} alt="FitLog Logo" width={24} height={24} className="w-6 h-6 object-contain"/>
    <span className="font-oswald text-lg tracking-widest text-white">FITLOG</span>
    </div>
    <p className="text-xs text-[#6B7280] font-medium">© 2026 FitLog — Workout Library. Train hard, log honest.</p>
    </div>
    </footer>
  );
};
