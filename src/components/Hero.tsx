...
export const Hero: React.FC = () => {
  ...
  return (
    ...
    <div className="lg:col-span-8 space-y-6">
     ...
     <h1 className="font-oswald text-5xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight uppercase leading-[1.08]">
    ...
    <div className="pt-2">
            <a href="#library" onClick={handleBrowseClick} className="inline-block px-6 py-3.5 rounded-lg bg-[#ccff00] hover:bg-[#b8e600] text-black font-extrabold text-xs uppercase tracking-wider transition-all duration-200 shadow-md shadow-[#ccff00]/10 transform hover:-translate-y-0.5 active:translate-y-0 cursor-pointer">
              BROWSE WORKOUTS
            </a>
    </div>
        </div>
